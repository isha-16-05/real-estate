    ...
    overflow-hidden' id='Footer'>
      ...
      justify-between items-start'>
        <div className='w-full md:w-1/3 mb-8 md:mb-0'>
            ...
            <p className='text-gray-400'>lorem Ipsum is simply dummy text of the printing and 
                typeseting industry. Lorem Ipsum has been the 
        ...
        <h3 className='text-white text-lg font-bold 
            ...
            <div className='flex gap-2'>
                ...
                <button className='py-2 pv-4 rounded bg-blue-500 
      ...
      text-gray-500'>
        copyright 2024 © GreatLearning. All Right Reserved.
      </div>
    </div>
  )
}
